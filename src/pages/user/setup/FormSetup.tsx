    ...
    <>
      ...
      <form onSubmit={handleSetup}>
        <div className="mb-[30px] ">
          ...
          <p className="text-sm">
            Enter form title and select the fields that you want your employee
            to fill in the options below. The defaults cannot be deselected.
          </p>
        </div>
          ...
          {activeTab === 1 && (
            <div className="flex py-5 px-7 flex-wrap gap-x-6 gap-y-2">
              ...
              <label htmlFor="gender" className="flex gap-2">
                <input type="checkbox" onChange={setPersonalInfo} id="gender" />
              ...
              <label htmlFor="phone" className="flex gap-2">
                <input type="checkbox" onChange={setPersonalInfo} id="phone" />
                <p className="text-sm">Phone Number</p>
              </label>
              <label htmlFor="email" className="flex gap-2">
                <input type="checkbox" onChange={setPersonalInfo} id="email" />
                <p className="text-sm">Email Address</p>
              </label>
              <label htmlFor="id" className="flex gap-2">
                <input type="checkbox" onChange={setPersonalInfo} id="id" />
                <p className="text-sm">National Identification Number (NIN)</p>
              </label>
              ...
              <label htmlFor="next_of_kin_relationship" className="flex gap-2">
                <input
                  type="checkbox"
                  onChange={setPersonalInfo}
        ...
        <div className="w-full rounded-xl border-[1px] border-stroke-clr bg-white mb-[30px]">
          ...
          {activeTab === 2 && (
            <div className="flex py-5 px-7 flex-wrap gap-x-6 gap-y-2">
              ...
              <label htmlFor="email" className="flex gap-2">
                <input type="checkbox" onChange={setGuarantorInfo} id="email" />
                <p className="text-sm">Email Address</p>
              </label>
